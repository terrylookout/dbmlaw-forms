...

                        {
                            <div className="row mt-5 mb-5" style={{
                                ...
                                <div className='col-auto p-3 ps-5' style={{
                                    ...
                                    <div style={{
                                        ...
                                        <svg width="48px" height="48px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path className="error" color="#000000" d="M12.5 9A3.5 3.5 0 0 0 9 12.5a3.5 3.5 0 0 0 3.5 3.5 3.5 3.5 0 0 0 3.5-3.5A3.5 3.5 0 0 0 12.5 9zm-.5 1h1v1.168c0 .348-.016.667-.047.957-.03.29-.069.581-.115.875h-.666a12.898 12.898 0 0 1-.125-.875 9.146 9.146 0 0 1-.047-.957zm.5 4a.5.5 0 0 1 .5.5.5.5 0 0 1-.5.5.5.5 0 0 1-.5-.5.5.5 0 0 1 .5-.5z" fill="#f22c42" overflow="visible" style={{
                                                marker: "none",
                                            }} />
                                        </svg>
                                    </div>
                                ...
                                <div className='col' style={{
                                    ...
                                    <p>
                                        <b>REMINDER TO COMPLETE YOUR SPECULATION AND VACANCY TAX ONLINE DECLARATION!</b>
                                    </p>
                                    <p>
                                        As a Home Owner you should have received or be receiving your 2023 Speculation and Vacancy Tax Declaration if your property of ownership falls within the applicable regions.
                                        These Declarations apply for the status of the property for the previous calendar year, 2022.
                                    </p>
                                    <p>
                                        Please take the time to review your letter and complete your online Declaration prior to the deadline of March 31, 2023.
                                        Should you need any assistance we would be more than happy to answer any questions you may have.
                                    </p>
                                </div>
                            </div>
                        }
