    ...
    return (
        <>
            ...
            <div className="row">
                <div className="col mb-3">
                    <div className='form-floating mb-0'>
                        <input type='text' className='form-control' id={`guarantorname${props.num}`} placeholder={`${props.text} ${props.num + 1} full legal name`}
            ...
            <div className="row">
                <div className="col mb-3">
                    <div className='form-floating mb-0'>
                        <input type='tel' className='form-control' id={`guarantorphone${props.num}`} placeholder='Phone number'
